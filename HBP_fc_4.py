...
class HBP(torch.nn.Module):
    def __init__(self):
        ...
        #getting conv4_3 by taking layers up to Relu
    ...
    def forward(self, X):
        ...
        resize_halve = torch.nn.Upsample(size=(28, 28), mode='bilinear')

        X_conv4_3 = self.features_conv4_3(X)

        X_conv4_3_down = resize_halve(X_conv4_3)
        ...
        # print("X_conv4_add_5_1")
        # print(X_conv4_add_5_1.shape)

        # print("X_conv4_add_5_2")
        # print(X_conv4_add_5_2.shape)

        # print("X_conv4_add_5_3")
        # print(X_conv4_add_5_3.shape)
