        ...
        for t in range(self._options['epochs']):
            ...
            if test_acc > best_acc:
                ...
                torch.save(self._net.state_dict(),
                           os.path.join('./model/'
                                        'HBP_all_c45_epoch_%d.pth' % (t + 1)))

            tr_writer.add_scalar('HBP All Training Loss', sum(epoch_loss) / len(epoch_loss), t + 1)
            tr_writer.add_scalar('HBP All Training Accuracy', train_acc, t + 1)
            va_writer.add_scalar('HBP All Validation Accuracy', test_acc, t + 1)
