#outputs the activation map on top of image
...
class HBPManager(object):
    def __init__(self, path):
        ...
        #hbp_load.load_state_dict(torch.load(path, map_location=device), strict = False)
        #hbp_load.eval()
        ...
        # print("Unicorn")
        # print(dir(self._net.modules))
        # print(self._net.state_dict())
        ...
        self._net.load_state_dict(torch.load(path, map_location=device), strict = False)
        self._net.eval()
