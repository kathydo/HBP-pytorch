...
class HBP(torch.nn.Module):
    ...
    def forward(self, X):
        ...
        X_conv4_concat5_1 = torch.cat((X_conv4_3, X_conv5_1_resize), 0)
        X_conv4_concat5_2 = torch.cat((X_conv4_3, X_conv5_2_resize), 0)
        X_conv4_concat5_3 = torch.cat((X_conv4_3, X_conv5_3_resize), 0)
